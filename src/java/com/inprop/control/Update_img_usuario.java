 ...
 * @author Ramon
 */
public class Update_img_usuario extends HttpServlet {
...
//                    path = getServletContext().getRealPath("../../web/imgProjeto");
                    path = getServletContext().getRealPath("../../web/fotos");
 ...
 try{
         int id= usu.getPerfil().getId();
        // perfilDao.update_foto(id, file);
         
         if(perfilDao!=null){
             Usuario usuario=(Usuario)usuarioDao.login(usu);
             session.setAttribute("usuario", usuario);
             out.print("atualizaçao feita");
         }else{
                      out.print("atualizaçao nao feita");
